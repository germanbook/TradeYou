...
namespace TradeYou.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> AddShoppingCart(Product product)
        {
            ...
            Product tempProduct = await _context.Products.FindAsync(product.PId);

            int ss = tempProduct.PQuantity;


            tempProduct.PQuantity--;

            int tt = tempProduct.PQuantity;
